...
public class AppNodesBuilder {
    ...
    public DatePicker buildDatePicker(Object nodeId,
        ...
        this.initNode(nodeId, datePicker, parent, styleClass, enabled);
        return datePicker;
    }
    ...
    public DatePicker buildDatePicker(Object nodeId,
            ...
            boolean enabled) {
        DatePicker datePicker = new DatePicker();
        this.initNode(nodeId, datePicker, parent, col, row, colSpan, rowSpan, styleClass, enabled);
    ...
    public ImageView buildImageView(Object nodeId, Pane parentPane, String styleClass, boolean enabled) {
        ImageView imageView = new ImageView();
        this.initNode(nodeId, imageView, styleClass, enabled);
        this.attachImage(imageView, nodeId);
        return imageView;
    }
    ...
    public ImageView buildImageView(Object nodeId,
            ...
            boolean enabled) {
        ImageView imageView = new ImageView();
        initNode(nodeId.toString(), imageView, parent, col, row, colSpan, rowSpan, styleClass, enabled);
        this.attachImage(imageView, nodeId);
        return imageView;
    }
    
    public void attachImage(ImageView imageView, Object nodeId) {
    ...
    public ComboBox buildComboBox(Object nodeId, Pane parentPane, String styleClass, boolean enabled) {
    ...
    public ComboBox buildComboBox(Object nodeId, GridPane parentPane,
            int col, int row, int colSpan, int rowSpan, String styleClass, boolean enabled) {
        ComboBox comboBox = new ComboBox();
        initNode(nodeId, comboBox, parentPane, col, row, colSpan, rowSpan, styleClass, enabled);
        return comboBox;
    }
    ...
    public TabPane buildTabPane(Object nodeId, 
        ...
        PropertiesManager props = PropertiesManager.getPropertiesManager();
        for (Object tabId : tabsOrder) {
            Node node = tabData.get(tabId);
            Tab tab = new Tab();
            String tabText = props.getProperty(tabId + "_TEXT");
            tab.setText(tabText);
            tab.setContent(node);
    ...
    public SplitPane buildSplitPane(Object nodeId,
            Pane parentPane,
            String styleClass,
            boolean enabled) {
        SplitPane splitPane = new SplitPane();
        initNode(nodeId, splitPane, parentPane, styleClass, enabled);
        return splitPane;
    }
    ...
    public ProgressBar buildProgressBar(Object nodeId,
                    Pane parent,
                    String styleClass, boolean enabled)  {
        ProgressBar progressBar = new ProgressBar();
        progressBar.setProgress(0.0);

        // INITIALIZE THE OTHER SETTINGS
        initNode(nodeId, progressBar, parent, styleClass, enabled);
    ...
    public ProgressBar buildProgressBar(Object nodeId,
        ...
        // INITIALIZE THE OTHER SETTINGS
        initNode(nodeId, progressBar, parent, col, row, colSpan, rowSpan, styleClass, enabled);
...
*/     //   slider.valueProperty().addListener((obs, oldval, newVal)
    ...
    public ScrollPane buildScrollPane(Object nodeId,
        ...
        this.initNode(nodeId, scrollPane, parentPane, styleClass, enabled);
        return scrollPane;
    }
